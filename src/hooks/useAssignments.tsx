  ...
  const fetchAssignments = async () => {
    try {
      ...
      const typedAssignments: Assignment[] = (data || []).map(assignment => ({
        ...
        status: assignment.status as 'pending' | 'accepted' | 'responded_to' | 'resolved' | 'assigned' | 'rejected' | 'verified' | 'needs_revision',
        resolved_at: assignment.resolved_at,
        resolved_by: assignment.resolved_by,
        resolution_notes: assignment.resolution_notes,
        witness_info: assignment.witness_info,
        resolution_evidence: assignment.resolution_evidence,
        response_timestamp: assignment.response_timestamp,
        response_timeframe: assignment.response_timeframe,
        operation_outcome: assignment.operation_outcome,
        casualties: assignment.casualties,
        injured_personnel: assignment.injured_personnel,
        civilians_rescued: assignment.civilians_rescued,
        weapons_recovered: assignment.weapons_recovered,
