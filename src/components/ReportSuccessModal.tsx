...
const ReportSuccessModal = ({ isOpen, onClose, reportId, serialNumber }: ReportSuccessModalProps) => {
  ...
  const copyToClipboard = (text: string) => {
    ...
    toast({
      title: "Copied!",
      description: "Secure reference number copied to clipboard",
    });
  };
...
Report ID: ${reportId}
Secure Reference Number: ${serialNumber}
Submission Date: ${new Date().toLocaleString()}

This reference number was securely generated by our system.
Please keep this reference number safe and confidential.
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-6 text-center">
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <p className="text-green-800 mb-3 font-semibold">Your Secure Reference Number:</p>
          ...
          <div className="text-gray-600 space-y-2 text-sm">
            ...
            <p>✓ Reference number was generated securely by our system</p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1 text-left">
              ...
              <li>• You can track status using your secure reference number</li>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
            <div className="flex items-center justify-center space-x-2 text-xs text-gray-600">
              ...
              <span>Reference number generated server-side for security</span>
            </div>
          </div>
