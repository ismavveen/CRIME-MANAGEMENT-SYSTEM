...
const ReportRedirect = () => {
  useEffect(() => {
    ...
    window.location.href = 'https://report-crime-ng.lovable.app';
  }, []);
    ...
    <div className="min-h-screen bg-dhq-dark-bg flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-400 text-sm mt-2">If you are not redirected automatically, 
          <a href="https://report-crime-ng.lovable.app" className="text-blue-400 hover:text-blue-300 underline ml-1">
            click here
          </a>
        </p>
      </div>
